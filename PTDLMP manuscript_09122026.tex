...
As shown in Table~\ref{tab:rq1-test-results}, the predeclared primary linear model (Logistic Regression with validation Platt calibration) demonstrates out-of-sample predictive utility, achieving a Test ROC-AUC of 0.595 and PR-AUC of 0.596 compared to 0.500 and 0.539 for the prevalence baseline. Importantly, Platt calibration achieves an exceptional Expected Calibration Error (ECE) of 0.0095 and reduces Brier score to 0.2404, ensuring that predicted probabilities $p_i$ reflect true posterior lateness frequencies suitable for risk-weighted targeting.
